            ...
            <div class="header"> <h3 id="head">Traffic Authentication
                ...
                <center>
                    <div id="column_box">
                        ...
                        <div id="columnCenter">
                            <h2>Add Vehicle Registration :</h2>
                            <form action="AddLicense" method="post">
                                <table width="338" border="0">
                                <tr>
                                        <td height="40"><div style="width:200px; height:20px; font-size:22px;" class="style3">Licence Number:</div></td>
                                        <td><input type="text" style="border-style: outset;width:200px; height:20px; name="fullName" /></td>
                                    </tr>
                                    <tr>
                                        <td width="175" height="40"><div style="width:200px; height:20px; font-size:22px;" class="style3">Aadhaar NO:</div></td>
                                        <td width="153"><input type="text" style="border-style: outset;width:200px; height:20px; name="licenseNumber" /></td>
                                    </tr>
                                    
                                    <tr>
                                        <td height="40"><div style="width:200px; height:20px; font-size:22px;" class="style3">Vehicle No: </div></td>
                                        <td><input type="text" style="border-style: outset;width:200px; height:20px; name="mailid" /></td>
                                    </tr>
                                    <tr>
                                        <td height="40"><div style="width:200px; height:20px; font-size:22px;" class="style3">Registered Date</div></td>
                                        <td><input type="text" style="border-style: outset;width:200px; height:20px; name="contact" /></td>
                                    </tr>
                                    <tr>
                                        <td height="40"><div style="width:200px; height:20px; font-size:22px;" class="style3">Nationality</div></td>
                                        <td><input type="text" style="border-style: outset;width:200px; height:20px; name="address" /></td>
                                    </tr>
                                    <tr>
                                        <td height="40"><div style="width:200px; height:20px; font-size:22px;" class="style3">Vehicle type</div></td>
                                        <td><select style="border-style:outset;width:200px;text-align:center; height:20px;" >
